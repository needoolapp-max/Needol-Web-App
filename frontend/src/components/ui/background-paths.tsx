...
export function NeedoolHero() {
  return (
    <section className="relative overflow-hidden border-b border-border bg-sidebar/90 min-h-[580px] flex items-center">
      ...
      <div className="relative z-10 mx-auto w-full max-w-5xl px-4 py-16 sm:py-20 text-center">
        ...
        >
          Needool connects you with active professionals, businesses, and
          opportunities — from Lagos to anywhere in the world.
        </motion.p>
